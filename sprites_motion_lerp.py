...
class Game(arcade.Window):
    ...
    def update(self, delta_time):
        ...
        self.player.center_x = arcade.utils.lerp(self.player.center_x, self._mouse_x, 0.2)
        self.player.center_y = arcade.utils.lerp(self.player.center_y, self._mouse_y, 0.2)
